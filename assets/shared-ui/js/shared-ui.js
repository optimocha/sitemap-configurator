...
(function ($) {
  ...
  if (0 !== $('.sui-2-10-6 .sui-accordion').length) {
    $('.sui-2-10-6 .sui-accordion').each(function () {
...
(function ($) {
  ...
  SUI.suiCodeSnippet = function () {
    ...
    $('.sui-2-10-6 .sui-code-snippet:not(.sui-no-copy)').each(function () {
...
(function ($) {
  ...
  $('.sui-2-10-6 .sui-slider').each(function () {
...
(function ($) {
  ...
  SUI.showHidePassword = function () {
    $('.sui-2-10-6 .sui-form-field').each(function () {
      var $this = $(this);
...
(function ($) {
  ...
  $('.sui-2-10-6 .sui-reviews').each(function () {
    var review = $(this);
...
(function ($) {
  ...
  $('.sui-2-10-6 .sui-side-tabs label.sui-tab-item input').each(function () {
    SUI.sideTabs(this);
  });
})(jQuery);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
(function ($) {
  ...
  if (0 !== $('.sui-2-10-6 .sui-tabs').length) {
    // Support tabs new markup.
    SUI.tabs(); // Support legacy tabs.

    SUI.suiTabs();
    $('.sui-2-10-6 .sui-tabs-navigation').each(function () {
...
(function ($) {
  ...
  if (0 !== $('.sui-2-10-6 .sui-tree').length) {
    $('.sui-2-10-6 .sui-tree').each(function () {
...
(function ($) {
  ...
  SUI.upload = function () {
    $('.sui-2-10-6 .sui-upload-group input[type="file"]').on('change', function (e) {
